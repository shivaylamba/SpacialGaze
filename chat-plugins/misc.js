...
exports.commands = {
	...
	credits: function (target, room, user) {
		...
		let popup = "|html|" + "<font size=5 color=#0066ff><u><b>SpacialGaze Credits</b></u></font><br />" +
			...
			"- " + (name)('alpha shivam', true) + " (Owner, Sysadmin, Development)<br />" +
			"- " + (name)('HoeenHero', true) + " ( Development)<br />" +
			"- " + (name)('lucky fandom', true) + " (Server Host)<br />" +
			"<br />" +
			"<u><b>Major Contributors:</b></u><br />" +
			"- " + (name)('hoeen hero', true) + " (Development)<br />" +
			"<br />" +
			"<u><b>Retired Staff:</b></u><br />" +
			"- " + (name)('spects', true) + " (Former Server Owner)<br />" +
			"- " + (name)('distrib', true) + " (Former Policy Leader)<br />" +
			"<br />" +
